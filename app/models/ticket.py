...
class DeviceTable(SQLModel, table=True):
    ...
    tickets: List["Ticket"] = Relationship(back_populates="device")
...
class Ticket(SQLModel, table=True):
    ...
    device_id: Optional[int] = Field(foreign_key="devicetable.id", nullable=True)
    ...
    device: DeviceTable = Relationship()
